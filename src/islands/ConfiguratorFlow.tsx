...
const MACHINE_HREF: any = { CubeTen: "/plastic-testing", CubeOne: "/rubber-testing", CubeGo: "/get-a-quote" }; // no CubeGo page yet
      ...
      <div style={{ position: "relative", display: "flow-root", maxWidth: 1440, margin: "0 auto", padding: m ? "60px 20px 56px" : "95px 64px 0", boxSizing: "border-box", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", marginTop: m ? 16 : 18, position: "relative" }}>
          ...
          <FadeSwap deps={model.name}>
            <Button variant="primary" style={{ whiteSpace: "nowrap" }} href={({ CubeTen: "/plastic-testing", CubeOne: "/rubber-testing", CubeGo: "/get-a-quote" } as any)[model.name] || "/plastic-testing"}>Explore {model.name}</Button>
          </FadeSwap>
        </div>
        {!m &&
